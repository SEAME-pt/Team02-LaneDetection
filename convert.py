...
model.load_state_dict(torch.load('Models/lane/lane_Mob_local_pretrained_tusimple2_epoch_20.pth', map_location=device))
model.eval()

dummy_input = torch.randn(1, 3, 256, 256).to(device)  

onnx_file_path = "Models/onnx/lane_Mob_local_pretrained_tusimple2_epoch_20.onnx"
torch.onnx.export(
