...
model.load_state_dict(torch.load('Models/lane/lane_Yolo_local1_epoch_25.pth', map_location=device))
model.eval()

dummy_input = torch.randn(1, 3, 128, 256).to(device)  

onnx_file_path = "Models/onnx/lane_Yolo_local1_epoch_25.onnx"
torch.onnx.export(
